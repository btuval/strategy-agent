...
const prompts = [
  {
    ...
    prompt: "Build a price increase strategy to achieve a 5% revenue increase. Distribute across all plan tiers, model projected churn by segment, and include mitigation tactics like bundled SVOD offers.",
    bg: "bg-blue-50",
  ...
  },
  {
    ...
    subtitle: "React to competitor's free Netflix offer",
    prompt: "A major competitor just announced free Netflix included with their base plan. Analyze the impact on our customer base, identify at-risk segments, and recommend a competitive response strategy.",
    bg: "bg-orange-50",
  ...
  },
  {
    ...
    prompt: "Analyze the High and Critical churn risk segments. Break down by tenure, plan tier, competition intensity, and payment history. Provide targeted retention recommendations for each sub-segment.",
    bg: "bg-red-50",
